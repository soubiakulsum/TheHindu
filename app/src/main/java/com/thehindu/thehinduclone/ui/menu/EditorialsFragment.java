...
public class EditorialsFragment extends Fragment implements CommunicationListernerForReadList {
    ClientCalls clientCalls = ClientCalls.Companion.getInstances();
    List<NewsResponse> newsResponses;
    RecyclerView recyclerView;

    public static EditorialsFragment newInstance(){
        EditorialsFragment editorialsFragment = new EditorialsFragment();
        return editorialsFragment;
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        SwipeRefreshLayout refreshRv = view.findViewById(R.id.refresh_entertainment);
        newsResponses = clientCalls.getSpecificNews(24, "try");
        recyclerView = view.findViewById(R.id.rv_entertainment);
        ...
        refreshRv.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                newsResponses = clientCalls.getSpecificNews(23, "movie");
                SideNavActivity.newsRvAdapter = new NewsRvAdapter(newsResponses,
                        EditorialsFragment.this);
                recyclerView.setAdapter(SideNavActivity.newsRvAdapter);
                SideNavActivity.newsRvAdapter.notifyDataSetChanged();
