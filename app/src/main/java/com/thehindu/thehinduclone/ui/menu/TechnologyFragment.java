...
public class TechnologyFragment extends Fragment implements CommunicationListernerForReadList {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SwipeRefreshLayout refreshRv = view.findViewById(R.id.refresh_tech);
        newsResponses = clientCalls.getSpecificNews(23, "tech");
